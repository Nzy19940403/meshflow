...
> {
    ...
    public CancelTask: any;
    public stageValueFn: any;
    public SettleTasks: any;
    ...
    constructor(
        ...
        this.taskSchduler = createTransactionScheduler(
            (updates: { path: P; key: SuggestKey<NM>; value: any; }[]) => this.batchNotify(updates),
            (path: P) => this.notify(path as P),
            {
    ...
    public GetNodeByPath = (path: P): MeshFlowTaskNode<P, any, NM>=> {
        ...
        if (uid === undefined) throw Error(MeshError.WrongId);
    ...
    public GetMaxUid = ()=> {
        console.log(this.AllBuckets.length)
        return this.uid;
    }
    ...
    public refresTarget(uid: number) {
...
>(
    ...
    // 返回绑定的方法，兼容旧接口
    // return {
    //     registerNode: scheduler.registerNode.bind(scheduler),
    //     registerGroupNode: scheduler.registerGroupNode.bind(scheduler),
    //     GetNodeByPath: scheduler.GetNodeByPath.bind(scheduler),
    //     GetNodeByUid: scheduler.GetNodeByUid.bind(scheduler),
    //     GetGroupByPath: scheduler.GetGroupByPath.bind(scheduler),
    //     notify: scheduler.notify.bind(scheduler),
    //     notifyAll: scheduler.notifyAll,
    //     batchNotify: scheduler.batchNotify,
    //     useEntangle: scheduler.entangleSystem.useEntangle,
    //     updateEntangleLevel: scheduler.entangleSystem.updateEntangleLevel,
    //     SetBucket: scheduler.SetBucket.bind(scheduler),
    //     GetBucket: scheduler.GetBucket.bind(scheduler),
    //     CancelTask: scheduler.meshTaskSystem.CancelTask,
    //     stageValueFn: scheduler.meshTaskSystem.stageValueFn,
    //     refresTarget: scheduler.refresTarget.bind(scheduler),
    //     SettleTasks: scheduler.taskSchduler.settleTasks,
    //     UITrigger: scheduler.UITrigger,
    //     UidToNodeMap: scheduler.UidToNodeMap
    // };
}